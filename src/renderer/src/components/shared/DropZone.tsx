...
export function DropZone({ children, onFilesDrop }: DropZoneProps) {
  ...
  return (
    ...
    >
      ...
      {isDragging && (
        <div className="absolute inset-0 z-50 bg-surface-0/95 flex items-center justify-center animate-overlay-in">
          <div className="drop-active border-2 border-dashed border-accent-main rounded-2xl px-16 py-14 flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-[16px] font-medium text-text-primary">Bilder hier ablegen</p>
              <p className="text-[13px] text-text-muted mt-1">
                Als Referenz für deine nächste Idee verwenden
              </p>
            </div>
          </div>
        </div>
